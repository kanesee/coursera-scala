...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var ans1 = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2$1, b$2$1, c$2$1) {
    return (function() {
      var jsx$2 = $uD(b$2$1.apply__O());
      var x$1 = $uD($m_Lcalculator_Polynomial$().computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a$2$1, b$2$1, c$2$1).apply__O());
      return ((((-jsx$2) - $uD($g["Math"]["sqrt"](x$1))) / 2) * $uD(a$2$1.apply__O()))
    })
  })(a, b, c));
  var ans2 = new $c_Lcalculator_Signal().init___F0(expr$1);
  $m_Lcalculator_Signal$();
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(ans1$1, ans2$1) {
    return (function() {
      var array = [$uD(ans1$1.apply__O()), $uD(ans2$1.apply__O())];
