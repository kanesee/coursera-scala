...
trait Solver extends GameDef {
  ...
  def from(initial: Stream[(Block, List[Move])],
    ...
    if( initial.isEmpty ) Stream.empty
      ...
      val more = newNeighborsOnly(nwh, explored+block)
...
//  {
//    val nwh = neighborsWithHistory(initial.head._1, initial.head._2)
//    val nnos = newNeighborsOnly(nwh, explored)
//    val rv = 
//    for {
//      nno <- nnos
//    } yield from(Stream.cons(nno, initial), explored + nno._1 )
//    
//    rv.flatten
//    
//  }
